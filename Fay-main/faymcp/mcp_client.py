...
class McpClient:
    ...
    #     """Lazy-load tools from fay_plugins/ once and cache them."""
    #     if not hasattr(self, "_cached_local_tools"):
    #         self._cached_local_tools = load_tools_from_folder("faymcp/fay_plugins")
    #         # Map for quick lookup
    #         self._local_tool_map = {t.name: t for t in self._cached_local_tools}
    #     return self._cached_local_tools
